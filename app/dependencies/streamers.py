...
from app.dependencies.twitch import get_event_sub_client, get_helix_client
...
def get_streamer_service(
    ...
    event_sub_client: EventSubClient = Depends(get_event_sub_client),
) -> StreamerService:
    return StreamerService(repository, unit_of_work, helix_client, event_sub_client)
